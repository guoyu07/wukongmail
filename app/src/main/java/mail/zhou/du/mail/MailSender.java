...
//		####################################################################################################
	 ...
	 * @return
     */
	public MailSender useMailPropertiesLiFang(){
		emailProperties = new Properties();
		emailProperties.put("mail.smtp.auth", "true");
		emailProperties.put("mail.smtp.host", "smtp.exmail.qq.com");
		emailProperties.put("mail.smtp.port", "465");
		emailProperties.put("mail.smtp.socketFactory.port", "465");
		emailProperties.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");
		emailProperties.put("mail.smtp.socketFactory.fallback", "false");
	...
	public void send() throws Exception {
			...
			if (TextUtils.isEmpty(fromName))
				...
				emailMsg.setFrom(new InternetAddress(usermail,fromName));
			...
			emailMsg.setContent(mailText, "text/html;charset=utf-8");
...
//			emailMsg.setContent(mailBody);
	...
	public MailSender setFromName(String fromName){
